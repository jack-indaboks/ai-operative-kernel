...
- **When to Run:** After operative files changed outside standard autonomy workflows.
- **Workflow:**
  1. Identify modified operative files and summarize what changed.
  2. Confirm required side effects (INDEX routing, cross-file references, and CHANGELOG entries where applicable).
