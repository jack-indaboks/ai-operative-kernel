...
This is the canonical index of autonomy files. Always review this manifest before opening other autonomy files. Follow each row's guidance. If a file requirement cannot be satisfied, skip that file and ask the operator for direction.

| File | Purpose | Requirements |
|------|---------|--------------|
| 00_CORE_autonomy.md | Read first and treat as governing runtime policy for autonomy workflows. | None |
| 01_INDEX_autonomy.md | Return here whenever you need to choose which autonomy files to load. | None |
